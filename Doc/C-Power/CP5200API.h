...
//====================================================================================
CP5200API int		CALLING_CONV CPowerBox_MakeSetProgramTemplateData2(HOBJECT hObj, BYTE byColor ,USHORT nWidth , USHORT nHeight , BYTE nWndNum , BYTE byOption, BYTE* pDefParam , BYTE* pWndParam);
